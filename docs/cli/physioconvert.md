...
| `SKIPPED` | The expected single-frequency `_physio.tsv.gz` already existed at its destination and was a valid, non-corrupt GZIP file; conversion was not attempted. |
