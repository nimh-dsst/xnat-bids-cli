...
- [`src/xnatcli/`](src/xnatcli/) — installable package that provides the `xnatcli` CLI (`xnatcli login`, `xnatcli download`, `xnatcli query`, `xnatcli mrihelp`, `xnatcli mriconvert`, `xnatcli cubids`, `xnatcli bidsmap`, `xnatcli physioconvert`), built on [PyXNAT](https://pyxnat.github.io/pyxnat/index.html).
